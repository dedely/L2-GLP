...
public class TestDemo {
	...
	public static void main(String[] args) {
		// Game game = new Game();
		OrderTreatment ot = new OrderTreatment();
		...
		Unit transportUnit1 = UnitFactory.createUnit(Constants.TEST_GROUND_EMBARK, new Coordinates(5, 0, Constants.GROUND), faction1);
		ot.giveOrdre(Constants.EMBARK_AAC, unit1, transportUnit1);
		...
		System.out.println("unit1 pos = " + unit1.getOrders().toString());
		System.out.println("unit1 pos = " + unit1.getOrders().toString());
