...
public class NightJarButton extends OrderButton{
	public NightJarButton(Faction player, String action) {
		super(player, action);
		initStyle();
		initLayout();
		initAction();
	...
	private void initAction() {
		getButton().addActionListener(new CreateNightJarAction());
	}

	private class CreateNightJarAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			for (Integer selectedId : selectedCollection) {
				try {
					...
					CreateUnit order = new CreateUnit(Constants.NIGHTJAR);
