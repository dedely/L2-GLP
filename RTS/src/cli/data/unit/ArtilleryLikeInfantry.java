...
public class ArtilleryLikeInfantry extends GroundUnit {
	...
	public ArtilleryLikeInfantry(String name, int cost, String playerName, int maxHealth, int armorPoints,
			int armorType, String description, Coordinates position, int speed, int damagePerShot, int damageType,
