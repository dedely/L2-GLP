...
public class UnitFactory {
	...
	private Unit buildTroopTransport(HashMap<String, String> unitDatas, String playerName, Coordinates spawnPosition) {
		return new TroopTransport(
				unitDatas.get("name"),
				playerName,
				toInt(unitDatas.get("maxHealth")),
				toInt(unitDatas.get("armorPoints")),
				toInt(unitDatas.get("armorType")),
				unitDatas.get("description"),
				spawnPosition,
				toInt(unitDatas.get("speed")),
				new Weapon(
						toInt(unitDatas.get("damagePerShot")),
						toInt(unitDatas.get("typeOfDammage")),
						toInt(unitDatas.get("timeBeetweenShots")),
						toInt(unitDatas.get("range")),
						toInt(unitDatas.get("minimuRange")),
						toBool(unitDatas.get("canShootAtAirTarget"))),
				toInt(unitDatas.get("unitSize")),
				toInt(unitDatas.get("infantrySeats")));
	}
	...
	private Unit buildGroundUnitWithMountedWeapon(HashMap<String, String> unitDatas,String playerName, Coordinates spawnPosition) {
		return new GroundUnitWithMountedWeapon(
				unitDatas.get("name"),
				playerName,
				toInt(unitDatas.get("maxHealth")),
				toInt(unitDatas.get("armorPoints")),
				...
				toInt(unitDatas.get("unitSize")),
				new Weapon(
						toInt(unitDatas.get("MWdamagePerShot")),
						toInt(unitDatas.get("MWtypeOfDammage")),
						toInt(unitDatas.get("MWtimeBeetweenShots")),
						toInt(unitDatas.get("MWrange")),
						toInt(unitDatas.get("MWminimuRange")),
						toBool(unitDatas.get("MWcanShootAtAirTarget"))));
		}
	...
	private Unit buildAttackHelicopter(HashMap<String, String> unitDatas, String playerName,
		...
		return new AttackHelicopter(
				...
				new Weapon(
						...
						toBool(unitDatas.get("canShootAtAirTarget"))),
				new Weapon(
						toInt(unitDatas.get("SecdamagePerShot")),
						toInt(unitDatas.get("SectypeOfDammage")),
						toInt(unitDatas.get("SectimeBeetweenShots")),
						toInt(unitDatas.get("Secrange")),
						toInt(unitDatas.get("SecminimuRange")),
						toBool(unitDatas.get("SeccanShootAtAirTarget"))));
	}
	private Unit buildGroundUnitSuicide(HashMap<String, String> unitDatas, String playerName,
			Coordinates spawnPosition) {
		return new GroundUnitSuicide(
				unitDatas.get("name"),
				playerName,
				toInt(unitDatas.get("maxHealth")),
				toInt(unitDatas.get("armorPoints")),
